...
| <a name="input_prometheus_alertmanager_persistence_enabled"></a> [prometheus\_alertmanager\_persistence\_enabled](#input\_prometheus\_alertmanager\_persistence\_enabled) | Enable persistence storage for Prometheus Alertmanager | `bool` | `false` | no |
...
| <a name="input_prometheus_persistent_volume_existing_claim"></a> [prometheus\_persistent\_volume\_existing\_claim](#input\_prometheus\_persistent\_volume\_existing\_claim) | Prometheus existing persistent volume claim name | `string` | `""` | no |
| <a name="input_prometheus_persistent_volume_size"></a> [prometheus\_persistent\_volume\_size](#input\_prometheus\_persistent\_volume\_size) | Prometheus persistent volume size | `string` | `"16Gi"` | no |
| <a name="input_prometheus_retention"></a> [prometheus\_retention](#input\_prometheus\_retention) | Prometheus data retention period | `string` | `"7d"` | no |
